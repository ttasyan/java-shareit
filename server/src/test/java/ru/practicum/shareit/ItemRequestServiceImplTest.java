...
public class ItemRequestServiceImplTest {
    ...
    void saveItemRequest() {
        long userId = 1L;
        User userDto = new User(1, "Пётр", "fjk@mail.ru");

        NewItemRequest itemRequest = new NewItemRequest();
        itemRequest.setDescription("des");
        ItemRequestDto itemRequestDto = new ItemRequestDto(1, "des", userDto, null, null);
        try {
             itemRequestDto = service.addRequest(userDto.getId(), itemRequest);
